...
export default function HomeScreen({ navigation }: Props) {
  ...
  // 3. CREATE (Mutação para criar) - COMPLETO
  ...
  // 4. UPDATE (Mutação para atualizar) - COMPLETO
  ...
  return (
    <View style={styles.container}>
      {/* 1. Header Adicionado (conforme Pagina inicial.pdf) */}
      <AppHeader canGoBack={true} />
        ...
        <FlatList
          ...
          ListFooterComponent={
            <>
              ...
              {/* 2. Botão de Sair (Logout) Adicionado */}
      ...
      {/* 3. Modal de Criar/Editar (conforme Editando nome treino.pdf) */}
      <Modal
      ...
      >
        ...
        >
          <View style={styles.modalContainer}>
            ...
            {/* O design 'Editando nome treino.pdf' mostra o input */}
            <TextInput
